...
The second advice intercepts calls to =org-md--headline-title=, which is the internal function the Markdown exporter uses to generate headlines in the selected headline style.
